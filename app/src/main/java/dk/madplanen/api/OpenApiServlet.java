...
public class OpenApiServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) {
        ...
        try(InputStream stream = context.getResourceAsStream(OPENAPI_PATH)) {
            if(stream == null) {
                resp.sendError(HttpServletResponse.SC_NOT_FOUND, "Kunne ikke finde OpenAPI documentation");
            } else {
            ...
            logger.log(Level.WARNING, "Kunne ikke læse OpenApi.yml fil.",exception);
